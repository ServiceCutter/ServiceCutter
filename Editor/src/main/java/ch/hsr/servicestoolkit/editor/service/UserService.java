...
import ch.hsr.servicestoolkit.editor.service.util.RandomUtil;
...
public class UserService {
	...
	public User createUserInformation(final String login, final String password, final String firstName, final String lastName, final String email, final String langKey) {
