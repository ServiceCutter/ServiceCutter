...
import ch.hsr.servicestoolkit.editor.Application;
import ch.hsr.servicestoolkit.editor.config.audit.AuditEventConverter;
import ch.hsr.servicestoolkit.editor.domain.PersistentAuditEvent;
import ch.hsr.servicestoolkit.editor.repository.PersistenceAuditEventRepository;
import ch.hsr.servicestoolkit.editor.service.AuditEventService;
...
public class AuditResourceTest {
	...
	public void getAudit() throws Exception {
		...
		// Get the audit
		restAuditMockMvc.perform(get("/api/audits/{id}", auditEvent.getId())).andExpect(status().isOk()).andExpect(content().contentType(MediaType.APPLICATION_JSON))
